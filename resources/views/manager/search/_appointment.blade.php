<li class="list-group-item">
    <div class="btn-group">
        ...
        {!! Button::normal($appointment->contact->fullname)->large()->withIcon(Icon::user())->asLinkTo(route('manager.business.contact.show', [$appointment->business, $appointment->contact->id])) !!}
