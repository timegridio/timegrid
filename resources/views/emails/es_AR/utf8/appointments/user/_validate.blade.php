...
<div class="title" style="font-family:Helvetica,Arial, sans-serif;font-size:18px;font-weight:600;color:#374550">Por favor confirma tu cita accediendo al siguiente link:</div>
...
Prestador: {{ $appointment->business->name }}
    Fecha: {{ $appointment->date }}
     Hora: {{ trans_choice('appointments.text.arrive_at', count($arriveAt = $appointment->arriveAt), $arriveAt) }} ({{ $appointment->timezone() }})
