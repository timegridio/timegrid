            ...
            <div class="col-md-offset-2">
                <div class="col-md-5">
                        ...
                        {!! Panel::normal()->withHeader('<strong>Prestadores</strong> Quiero dar turnos por internet')->withBody(
                            Thumbnail::image('//placehold.it/350x150')->caption('Si <strong>tenés un negocio o sos prestador</strong>, acá podés dar de alta tu comercio y empezar a dar turnos por internet.').
                ...
                <div class="col-md-5">
                    ...
                    {!! Panel::normal()->withHeader('<strong>Clientes</strong> Quiero pedir turnos por internet')->withBody(
                        Thumbnail::image('//placehold.it/350x150')->caption('Si <strong>querés encontrar un prestador</strong> para reservar sus servicios, acá podés encontrar el que más te gusta y reservar tu turno!.').
