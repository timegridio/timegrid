<li class="dropdown">
    ...
    @endif
        <li>
            <a href="{{ route('user.businesses.list') }}">{{ trans('app.nav.user.business.selector') }}</a>
        </li>
        <li>
        ...
        <li class="nav-divider"></li>
        <li>
            <a href="{{ route('user.booking.list') }}">{{ trans('app.nav.user.business.my_appointments') }}</a>
        </li>
        <li class="nav-divider"></li>
        <li>
            <a href="{{ route('user.wizard.welcome') }}">{{ trans('app.nav.wizard') }}</a>
        </li>
    </ul>
</li>